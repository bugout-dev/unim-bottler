...
class BottlerInitializer:
    def __init__(self, contract_address: Optional[ChecksumAddress]):
        self.contract_name = "BottlerInitializer"
        self.address = contract_address
        self.contract = None
        self.abi = get_abi_json("BottlerInitializer")
...
def handle_deploy(args: argparse.Namespace) -> None:
    ...
    contract = BottlerInitializer(None)
...
def handle_verify_contract(args: argparse.Namespace) -> None:
    network.connect(args.network)
    contract = BottlerInitializer(args.address)
...
def generate_cli() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="CLI for BottlerInitializer")
